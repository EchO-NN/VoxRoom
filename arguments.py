...
def get_args():
    ...
    parser.add_argument('-efh', '--env_frame_height', type=int, default=256,  # 256
                        help='Frame height (default:84)')
    parser.add_argument('-fw', '--frame_width', type=int, default=256,  # 128 for ANS, 256 for my method  # this is the resolution for image
                        help='Frame width (default:84)')
    parser.add_argument('-fh', '--frame_height', type=int, default=256,  # 128 for ANS, 256 for my method
                        help='Frame height (default:84)')
    parser.add_argument('-el', '--max_episode_length', type=int, default=1000,#1000
                        help="""Maximum episode length in seconds for
                                Doom (default: 180)""")
    parser.add_argument("--sim_gpu_id", type=int, default=0,
                        help="gpu id on which scenes are loaded")
    parser.add_argument("--task_config", type=str,
                        default="tasks/pointnav_gibson.yaml",#gibson  # pointnav_gibson or pointnav_gibsontest  #
                        help="path to config yaml containing task information")
    parser.add_argument("--split", type=str, default="train",
                        help="dataset split (train | val | val_mini) ")
    parser.add_argument('-na', '--noisy_actions', type=int, default=0)#1
    parser.add_argument('-no', '--noisy_odometry', type=int, default=0)#1
    parser.add_argument('--camera_height', type=float, default=1.25,#1.25
                        help="agent camera height in metres")
    parser.add_argument('--hfov', type=float, default=90.0,#90.0
    ...
    parser.add_argument('-sbs', '--slam_batch_size', type=int, default=72)#72
    ...
    parser.add_argument('--vision_range', type=int, default=60)#64 when run the main.py  60~3m 40~2m
    parser.add_argument('--obstacle_boundary', type=int, default=5)
    parser.add_argument('--map_resolution', type=int, default=5)
    parser.add_argument('--du_scale', type=int, default=2)
    parser.add_argument('--map_size_cm', type=int, default=4800) # 2400 ANS 4800 others
