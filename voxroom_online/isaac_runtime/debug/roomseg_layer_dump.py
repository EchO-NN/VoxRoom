...
def save_roomseg_layer_dump(
    *,
    ...
    stem = (
        ...
        else "roomseg_step_%06d" % int(step)
    )
    if not stem or Path(stem).name != stem:
        raise ValueError("roomseg snapshot filename_stem must be a plain filename stem")
    paths = {
...
def build_roomseg_debug_arrays(
    *,
    ...
    mapping = {
        ...
        "runtime_global_frontier_map": "runtime_global_frontier_map",
    }
